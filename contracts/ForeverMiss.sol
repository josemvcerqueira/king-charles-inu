...
contract KingChalesInu is OwnableRoles {
        ...
        )
    {
        ...
        return (
            ...
            rLiquidityFee,
            rMarketingFee,
            burnFee + liquidityFee + marketingFee
        );
    }
    ...
    {
        burnFee = _calculateBurnFee(tAmount);
        liquidityFee = _calculateLiquidityFee(tAmount);
        marketingFee = _calculateMarketingFee(tAmount);
        tTransferAmount = tAmount - burnFee - liquidityFee - marketingFee;
    }
        ...
        )
    {
        ...
        rMarketingFee = tMarketingFee * currentRate;
